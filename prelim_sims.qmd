...
robust_bias_table <- data.frame(
  SampleSize = out$n,
  Robust_Bias_V1 = out$robust_bias.V1,
  Robust_Bias_V2 = out$robust_bias.V2
)

emp_sd_table <- data.frame(
  SampleSize = out$n,
  Empirical_SD_V1 = out$emp_sd.V1,
  Empirical_SD_V2 = out$emp_sd.V2
)

emp_mad_table <- data.frame(
  SampleSize = out$n,
  Empirical_MAD_V1 = out$emp_mad.V1,
  Empirical_MAD_V2 = out$emp_mad.V2
)
```
...
```{r}
# Inline tables
knitr::kable(bias_table, caption = "Bias for V1 and V2 across Sample Sizes")
knitr::kable(robust_bias_table, caption = "Robust Bias for V1 and V2 across Sample Sizes")
knitr::kable(emp_sd_table, caption = "Empirical Standard Deviation for V1 and V2 across Sample Sizes")
knitr::kable(emp_mad_table, caption = "Empirical MAD for V1 and V2 across Sample Sizes")
```
